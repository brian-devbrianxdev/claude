...
| Path | What it is |
|------|-----------|
| `skills/` | 12 capability-named skills (see `skills/README.md`) |
| `commands/` | Lifecycle commands: `/start-task`, `/ship-task` |
| `rules/` | Workspace rules (layering, JDK matrix, two DBs, contract sync, the Java gate) |
...
## Skill architecture
Consolidated from 29 skills to **12** across two passes — see `skills/README.md` for the full map
