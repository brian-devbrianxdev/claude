---
name: code-review
description: Detect potential code-level performance smells in Java - streams, collections, boxing, regex, object creation. Provides awareness, not absolutes - always measure before optimizing. For JPA/database performance, use spring-stack-patterns (JPA section) instead.
---
...
**For database:** Use `spring-stack-patterns` skill, JPA section (N+1, lazy loading, pagination)
**For architecture:** Use `code-review` skill
